    ...
    competences: [
        {
            ...
            name: "Gestion de switch",
            details: [ "Trunking", "VTP", "Gestion VLAN", "Port mirroring", "SSH / TELNET", "802.1x" ]
        },
        {
            icon: `<svg viewBox="0 -127 1278 1278" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M186.97049 390.020858c249.283591-143.926213 654.058848-143.926213 903.342438 0 249.283591 143.921015 249.283591 377.621133 0 521.542148-249.283591 143.926213-654.058848 143.926213-903.342438 0-249.288789-143.921015-249.288789-377.621133 0-521.542148z" fill="#4467AE"></path><path d="M0.005198 368.719633h1277.273022v282.072299H0.005198z" fill="#4467AE"></path><path d="M186.97049 107.948559c249.283591-143.926213 654.058848-143.926213 903.342438 0 249.283591 143.921015 249.283591 377.621133 0 521.542148-249.283591 143.926213-654.058848 143.926213-903.342438 0-249.288789-143.921015-249.288789-377.621133 0-521.542148z" fill="#6D8ACA"></path><path d="M436.243685 524.263279l57.323062 33.095388-164.5621-6.819719-11.814955-95.008246 57.323063 33.095388 148.037797-85.475194 61.73093 35.642386-148.037797 85.469997zM846.320857 216.221989l-57.323063-33.09019 164.562101 6.819719 11.814954 95.008246-57.323062-33.095388-148.037797 85.469996-61.73093-35.637188 148.037797-85.475195zM445.418078 199.744468l57.323062-33.09019-164.5621 6.819718-11.814955 95.008246 57.323063-33.095388 148.042995 85.469997 61.730929-35.637189L445.418078 199.744468zM865.501316 513.560686l-57.323063 33.095388 164.5621-6.819718 11.814955-95.008246-57.323062 33.095388-148.037797-85.469997-61.73093 35.637189 148.037797 85.469996z" fill="#FFFFFF"></path></g></svg>`,
            name: "Gestion de routeur",
            details: [ "Routage statique et dynamique via RIP", "Implémentation du DHCP / Agent relais DHCP", "Gestion d'ACL", "Gestion NAT et PAT", "Tunnel VPN (IPSec)" ]
        },
        {
            ...
            name: "Administration et configuration système",
            details: [ "Windows Server : Active Directory / GPO / DHCP / DNS / DDNS / Unités Organisationnelles / Partages", "Linux : DNS / DHCP / LDAP / HAProxy / Samba / FTP / PostFix / Squid", "Virtualisation : VMware / Hyper-V / VirtualBox / Proxmox" ]
        },
        {
            ...
            name: "Cybersécurité",
            details: [
                "Attaque & contre-mesure : DoS SYN Flood (Cisco TCP Intercept), MITM SSH (ARP Poisoning), Rogue DHCP (Snooping), Exploit EternalBlue (SMBv1)",
                "Durcissement : OpenSSH (fail2ban, auth. par clé, restrictions), chiffrement TLS (Apache HTTPS), 802.1x",
                "Surveillance : Centralisation de logs (Graylog, LogAnalyzer/Syslog), supervision d'infrastructure (Zabbix)"
            ]
        },
        {
            icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#6366f1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>`,
            name: "Compétences fondamentales",
            details: [
                "Maîtrise de l'adressage IPv4 + subnetting",
                "Protocoles : 802.1Q / 802.1x / ARP / IP / ICMP / DHCP / UDP / TCP / DNS / LDAP / HTTP / HTTPS / SSH / TLS",
                "Capture et analyse de trames réseau (Wireshark)"
            ]
        }
    ],
...
},
{
    ...
    longDescription: "Déploiement et configuration de Windows Server Update Services (WSUS) pour centraliser et automatiser les mises à jour des postes Windows en environnement d'entreprise.",
    path: "wsus.pdf",
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="#6366f1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>`,
...
// --- 7. CERTIFICATIONS ---
    certifications: [
        { 
            ...
            pdf: "",
            rootmeStats: {"total":26,"themes":[{"name":"Réseau","count":18,"total":1},{"name":"Web-Client","count":8,"total":1}],"position":49112,"score":345,"rang":"curious","top_percent":null,"updated_at":"2026-04-27T10:03:11Z"},
...
<g id="g13" transform="matrix(1.8928864,0,0,1.8928864,-264.72593,-165.92773)">
        ...
        { 
            ...
            issuer: "pix.fr", 
            url: "https://pix.fr", 
            pdf: "certification-pix-20260303.pdf",
            icon: `<svg viewBox="0 0 24 24" fill="none" stroke="#6366f1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-4 12.7V17h8v-2.3A7 7 0 0 0 12 2z"/></svg>`
        },
        { 
            name: "Cyber101", 
            issuer: "cyber101.com", 
    ...
    documentsE5: [
        {
            ...
            description: "Tableau de synthèse E5 — BTS SIO Session 2026",
            path: "E5/e5-tableau.pdf",
            icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>`,
            type: "pdf"
        },
        {
            title: "Attestation de stage — Ellix Informatique",
            description: "Stage de 1 mois — Mai à Juin 2025 — Hérouville-Saint-Clair",
            path: "E5/Attestation_de_stage_Ellix_Informatique.pdf",
            icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>`,
            type: "pdf"
        },
        {
            title: "Attestation de stage — Fondation de la Miséricorde",
            description: "Stage de 7 semaines — Décembre 2025 à Février 2026 — Caen",
            path: "E5/Attestation_de_stage_Misericorde.pdf",
            icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>`,
            type: "pdf"
        },
        {
            title: "Diaporama E5",
            description: "Diaporama de présentation E5 — BTS SIO Session 2026",
