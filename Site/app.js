...
function onTurnstileLoad() {
    ...
    const steps = [
        { target: 15,  delay: 100,  step: 3,  msg: "Connexion à Cloudflare..." },
        { target: 40,  delay: 80,   step: 2,  msg: "Chargement du captcha..." },
        { target: 72,  delay: 120,  step: 1,  msg: "En attente de vérification..." },
        { target: 88,  delay: 200,  step: 0.5, msg: "En attente de vérification..." },
    ];
